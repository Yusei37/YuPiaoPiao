...
import com.example.yusei.yupiaopiao.adapter.FilmArrangementAdapter;
import com.example.yusei.yupiaopiao.adapter.Movie2Adapter;
import com.example.yusei.yupiaopiao.beans.*;
...
//    }
    ...
    private void initFilmArrangement() {
        ...
        }).execute(IP.IP+"/ServletTest/FilmArrangementServlet");
    }
